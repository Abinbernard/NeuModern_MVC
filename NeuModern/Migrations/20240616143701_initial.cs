        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MultipleAddressId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderHeaders_MultipleAddresses_MultipleAddressId",
                        column: x => x.MultipleAddressId,
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 1, true, "T-Shirt" },
                    { 2, 2, true, "Casual Shirts" },
                    { 3, 3, false, "Formal Shirts" },
                    { 4, 4, true, "Jackets" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Brand", "CategoryId", "DateTime", "Description", "Discount", "Name", "OfferPrice", "Price", "Size", "StockQuantity" },
                values: new object[,]
                {
                    { 1, "Roadster", 1, new DateTime(2024, 6, 16, 20, 7, 0, 221, DateTimeKind.Local).AddTicks(3551), "A dress can have sleeves, straps, or be held up with elastic around the chest, leaving the shoulders bare. Dresses also vary in color. The hemlines of dresses vary depending on modesty, weather, fashion or the personal taste of the wearer.", 63m, "Colourblocked T-Shirt", 799m, 1749m, "Medium", 5 },
                    { 2, "Bullmer", 1, new DateTime(2024, 6, 16, 20, 7, 0, 221, DateTimeKind.Local).AddTicks(3564), "A dress can have sleeves, straps, or be held up with elastic around the chest, leaving the shoulders bare. Dresses also vary in color. The hemlines of dresses vary depending on modesty, weather, fashion or the personal taste of the wearer.", 74m, "Oversized T-Shirt", 389m, 1449m, "Small", 1 },
                    { 3, "Powerlook", 2, new DateTime(2024, 6, 16, 20, 7, 0, 221, DateTimeKind.Local).AddTicks(3566), "A dress can have sleeves, straps, or be held up with elastic around the chest, leaving the shoulders bare. Dresses also vary in color. The hemlines of dresses vary depending on modesty, weather, fashion or the personal taste of the wearer.", 45m, "Casual Shirt", 1099m, 1999m, "Medium", 3 },
                    { 4, "Ketch", 4, new DateTime(2024, 6, 16, 20, 7, 0, 221, DateTimeKind.Local).AddTicks(3569), "A dress can have sleeves, straps, or be held up with elastic around the chest, leaving the shoulders bare. Dresses also vary in color. The hemlines of dresses vary depending on modesty, weather, fashion or the personal taste of the wearer.", 78m, "Denim Jacket", 659m, 2999m, "Larger", 4 },
                    { 5, "Roadster", 3, new DateTime(2024, 6, 16, 20, 7, 0, 221, DateTimeKind.Local).AddTicks(3571), "A dress can have sleeves, straps, or be held up with elastic around the chest, leaving the shoulders bare. Dresses also vary in color. The hemlines of dresses vary depending on modesty, weather, fashion or the personal taste of the wearer.", 70m, "Slim Fit Shirt", 479m, 1500m, "Small", 4 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHeaders_MultipleAddressId",
                table: "OrderHeaders",
